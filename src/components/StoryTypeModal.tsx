...
const storyTypes: StoryType[] = [
  {
    ...
    prompt: 'Write an adventurous story with elements of exploration, challenge, and discovery. Include vivid descriptions and engaging action sequences.',
    icon: MapIcon
  },
  {
    id: 'fantasy',
    ...
    prompt: 'Create a fantasy story with magical elements, unique creatures, and wonder. Include rich world-building and mystical elements.',
    icon: SparklesIcon
  },
  {
    id: 'mystery',
    ...
    prompt: 'Write a mysterious story with clever clues, suspense, and an engaging puzzle to solve. Focus on building tension and curiosity.',
  ...
  },
  {
    ...
    prompt: 'Create a heartwarming romance story that explores relationships and emotions. Focus on character development and meaningful connections.',
    icon: HeartIcon
  },
  {
    id: 'historical',
    ...
    prompt: 'Write a story set in a historical period, weaving in authentic details and events. Create an immersive historical atmosphere while telling a compelling tale.',
    icon: BookOpenIcon
  },
  {
    id: 'comedy',
    ...
    prompt: 'Create a lighthearted, humorous story with clever wit and entertaining situations. Include fun dialogue and amusing scenarios.',
    icon: FaceSmileIcon
  },
  {
    id: 'scifi',
    ...
    prompt: 'Write a science fiction story with advanced technology, space exploration, or futuristic concepts. Include innovative ideas and thought-provoking scenarios.',
  ...
  },
  {
    ...
    prompt: 'Create a fable-like story with memorable characters and a meaningful moral lesson. Include creative storytelling and universal wisdom.',
    icon: StarIcon
  }
];
